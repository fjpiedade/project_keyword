 ...
 * @author fernandojoao
 */
public class SeverletRegistarAnuncio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            resultado=ctrlAnuncio.registarClique(idAnuncio);
        } catch (SQLException ex) {
            Logger.getLogger(SeverletRegistarAnuncio.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        if(resultado==true)
                response.sendRedirect("feedback.jsp");
            else
                response.sendRedirect("seleccao.jsp");
    }
