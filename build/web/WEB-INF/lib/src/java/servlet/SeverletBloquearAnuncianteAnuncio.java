 ...
 * @author fernandojoao
 */
public class SeverletBloquearAnuncianteAnuncio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            resultado=ctrlAnuncio.desactivarAnuncio(idAnuncio);
        } catch (SQLException ex) {
            Logger.getLogger(SeverletBloquearAnuncio.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SeverletBloquearAnuncianteAnuncio.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
