 ...
 * @author fernandojoao
 */
public class SeverletActivarAnunciante extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (controle.validUsernameAndPassword(emailAnunciante, senhaAnunciante)) {
                ...
                controle2.activarConta(idAnunciante);
                response.sendRedirect("activarAnuncianteMsn.jsp");

            } else {
                response.sendRedirect("errorActivarAnuncianteMsn.jsp");
            }
        } finally {
            out.close();
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SeverletActivarAnunciante.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
