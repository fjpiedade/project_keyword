 ...
 * @author fernandojoao
 */
public class SeverletActivarAllAnuncio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SeverletActivarAllAnuncio.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        if(resultado==true)
                response.sendRedirect("utilizadorAllAnuncios.jsp");
            else
                response.sendRedirect("utilizadorAllAnuncios.jsp");
    }
